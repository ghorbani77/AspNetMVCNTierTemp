...
namespace MVC5.Web.Controllers
{
    public partial class InstallController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Start = "~/Views/Install/Start.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_InstallController : MVC5.Web.Controllers.InstallController
    {
        ...
        [NonAction]
        partial void StartOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MVC5.ViewModel.AdminArea.User.InstallViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Start(MVC5.ViewModel.AdminArea.User.InstallViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Start);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
            StartOverride(callInfo, viewModel);
